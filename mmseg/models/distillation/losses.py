...
# # class ChannelGroupLossWithMask(Baseloss):
# #         # group the channels and apply softmax
# #     def __init__(self,weight,tau,group_num):
# #         super().__init__(weight,tau)
# #         self.group_num = group_num
...
class KLDLoss(nn.Module):
    def __init__(self,weight,tau,softmax_dim):
        super().__init__()
        self.weight = weight
        self.tau = tau
        self.softmax_dim = softmax_dim
...
class ChannelGroupLossForLogits(KLDLoss):
    def __init__(self,weight,tau,group_size,apply_mask=False):
        super().__init__(weight,tau,softmax_dim=-1)
...
class SpatialGroupLossForLogits(KLDLoss):
    def __init__(self,weight,tau,kernel_size, dilation, padding, stride, apply_mask=False):
        super().__init__(weight,tau,softmax_dim=-1)
        self.kernel_size = kernel_size
        self.dilation = dilation
        self.padding = padding
...
class ChannelGroupLossForAttention(KLDLoss):
    def __init__(self,weight,tau,group_size):
        super().__init__(weight,tau,softmax_dim=-1)
        self.group_size = group_size
    def _transform(self,x):
...
class SpatialGroupLossForAttention(KLDLoss):
    def __init__(self,weight,tau,kernel_size, dilation, padding, stride,):
        super().__init__(weight,tau,softmax_dim=-1)
        self.kernel_size = kernel_size
        self.dilation = dilation
        self.padding = padding
