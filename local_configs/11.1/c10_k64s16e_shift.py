...
model = dict(
    ...
    distillation = [
        ...
        'loss_config':{
            ...
            'mask_config':False,
            'transform_config':{'loss_type':'spatial','kernel_size':64,'stride':16},
            'ff_config':False,
...
work_dir = '/apdcephfs/private_inchzhang/shared_info/10.30/c10k64s16'
...
data = dict(samples_per_gpu=2)
evaluation = dict(interval=2000, metric='mIoU')  
work_dir = '/apdcephfs/private_inchzhang/shared_info/11.1/c10k64s16e_shift'
resume_from = work_dir+'/latest.pth'
