...
work_dir = './work_dirs/logits_mlp_attn'
...
model = dict(
        ...
        layers=[
            ...
            ['backbone.block2.1.mlp.fc2','backbone.block2.7.mlp.fc2',[64,128],3],
            ['backbone.block3.1.norm2','backbone.block3.26.norm2',[160,320],3],
            ['backbone.block3.1.mlp.fc2','backbone.block3.26.mlp.fc2',[160,320],3],
