...
work_dir = './work_dirs/attention_stage3'
...
model = dict(
    ...
    distillation = [
        ...
        'loss_name':'SpatialGroupLossForAttention',
        'loss_config':{'weight':0.4,'tau':1,'kernel_size':1, 'dilation':1, 'padding':0,'stride':1,
                        'ff':{'c_in':256,'c_out':256,'dim':-1}},
    }
    ],
