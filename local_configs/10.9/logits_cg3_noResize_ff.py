...
work_dir = './work_dirs/logits_cg3_noResize_ff'
...
model = dict(
    ...
    distillation = [
        ...
        'loss_name':'ChannelGroupLossForLogits',
        'loss_config':{'weight':1,'tau':1,'group_size':3,'apply_resize':False,
                        'ff':{'c_in':150,'c_out':150,'dim':1}},
                        },
    ],
