...
model = dict(
    ...
    distillation = [
        ...
        'loss_name':'AttentionLoss',
        'loss_config':{
            'weight':0.1,
            'tau':1,
            'transform_config':{'loss_type':'channel','group_size':32},
        ...
        'loss_config':{
            'weight':0.1,
            'tau':1,
            'transform_config':{'loss_type':'channel','group_size':64},
            'earlystop_config':80000,
            'warmup_config':10000
            },
        },
        ...
        'loss_config':{
            'weight':0.1,
            'tau':1,
            'transform_config':{'loss_type':'channel','group_size':120},
            'earlystop_config':80000,
            'warmup_config':10000
            },
        },
...
work_dir = '/apdcephfs/private_inchzhang/shared_info/10.20/allsoftmax_re'
# resume_from = ''
