...
model = dict(
    ...
    distillation = [
        ...
        'loss_config':{
            ...
            'resize_config':False,
            'mask_config':False,
            'transform_config':{'loss_type':'channel','group_size':16},
        ...
        'loss_config':{
            ...
            'ff_config':{'in_channels':64, 'out_channels':128, 'kernel_size':1}
            },
        },
        ...
        'loss_config':{
            ...
            'mask_config':False,
            'transform_config':{'loss_type':'channel','group_size':1},
            'ff_config':{'in_channels':160, 'out_channels':320, 'kernel_size':1}
            },
        },
        ...
        'loss_config':{
            ...
            'mask_config':False,
            'transform_config':{'loss_type':'channel','group_size':1},
            'ff_config':{'in_channels':256, 'out_channels':512, 'kernel_size':1}
            },
        },
...
work_dir = '/apdcephfs/private_inchzhang/shared_info/feature'
