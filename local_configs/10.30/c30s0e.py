...
model = dict(
    ...
    distillation = [
        ...
        #     'mask_config':False,
        #     'transform_config':{'loss_type':'spatial','kernel_size':128,'stride':128},
        #     'ff_config':False,
        ...
        'loss_config':{
            ...
            'mask_config':False,
            'transform_config':{'loss_type':'channel','group_size':30},
            'ff_config':False,
            'earlystop_config':120000,
            },
        },
...
work_dir = '/apdcephfs/private_inchzhang/shared_info/10.30/c30s0e'
