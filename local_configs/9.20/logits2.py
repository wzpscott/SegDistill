# b1<-b4 的logits蒸馏 只训练teacher预测正确的部分
_base_ = [
...
work_dir = './work_dirs/9.20/logits2'
model = dict(
    cfg=dict(
            type='EncoderDecoder',
            backbone=dict(
    ...
    cfg_t=dict(
        ...
        parse_mode='regular',
        use_attn=False,
        logits_weights=[0,1,1,0,1], # [bg_mask,SrTr_mask,SfTr_mask,SfTf_mask,SrTf_mask]
...
# resume_from = './work_dirs/9.20/logits2/latest.pth'