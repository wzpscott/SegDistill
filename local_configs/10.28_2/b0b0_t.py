...
model = dict(
    ...
    distillation = [
        {'student_layer':['backbone.block1.0.attn.ATTN','backbone.block1.0.attn.V'],
        'teacher_layer':['backbone.block1.0.attn.ATTN','backbone.block1.0.attn.V'],
        'loss_name':'TeacherRE',
        'loss_config':{
            'weight':weight,
            'tau':1,
        ...
        {'student_layer':['backbone.block2.0.attn.ATTN','backbone.block2.0.attn.V'],
        'teacher_layer':['backbone.block2.0.attn.ATTN','backbone.block2.0.attn.V'],
        'loss_name':'TeacherRE',
        'loss_config':{
            'weight':weight,
            'tau':1,
        ...
        {'student_layer':['backbone.block3.0.attn.ATTN','backbone.block3.0.attn.V'],
        'teacher_layer':['backbone.block3.0.attn.ATTN','backbone.block3.0.attn.V'],
        'loss_name':'TeacherRE',
        'loss_config':{
            'weight':weight,
            'tau':1,
        ...
        {'student_layer':['backbone.block4.0.attn.ATTN','backbone.block4.0.attn.V'],
        'teacher_layer':['backbone.block4.0.attn.ATTN','backbone.block4.0.attn.V'],
        'loss_name':'TeacherRE',
        'loss_config':{
            'weight':weight,
            'tau':1,
