...
model = dict(
    ...
    distillation = [
        ...
        # attention
        {'student_layer':'backbone.block1.1.attn.ATTN','teacher_layer':'backbone.block1.2.attn.ATTN',
        'loss_name':'ChannelWiseLossAttention',
        'loss_config':{'weight':1,'tau':1},
        'inspect_mode':True},
        {'student_layer':'backbone.block2.1.attn.ATTN','teacher_layer':'backbone.block2.2.attn.ATTN',
        'loss_name':'ChannelWiseLossAttention',
        'loss_config':{'weight':1,'tau':1},
        'inspect_mode':True},
        {'student_layer':'backbone.block3.1.attn.ATTN','teacher_layer':'backbone.block3.17.attn.ATTN',
        'loss_name':'ChannelWiseLossAttention',
        'loss_config':{'weight':1,'tau':1},
        'inspect_mode':True},
        {'student_layer':'backbone.block4.1.attn.ATTN','teacher_layer':'backbone.block4.2.attn.ATTN',
        'loss_name':'ChannelWiseLossAttention',
        'loss_config':{'weight':1,'tau':1},
        'inspect_mode':True},
        # feature
        {'student_layer':'backbone.block1.1.mlp.fc2','teacher_layer':'backbone.block1.2.mlp.fc2',
        'loss_name':'ChannelWiseLossFeature',
        'loss_config':{'weight':1,'tau':1},
        'channel_nums':[32,64],
        'inspect_mode':True},
        {'student_layer':'backbone.block2.1.mlp.fc2','teacher_layer':'backbone.block2.2.mlp.fc2',
        'loss_name':'ChannelWiseLossFeature',
        'loss_config':{'weight':1,'tau':1},
        'channel_nums':[64,128],
        'inspect_mode':True},
        {'student_layer':'backbone.block3.1.mlp.fc2','teacher_layer':'backbone.block3.17.mlp.fc2',
        'loss_name':'ChannelWiseLossFeature',
        'loss_config':{'weight':1,'tau':1},
        'channel_nums':[160,320],
        'inspect_mode':True},
        {'student_layer':'backbone.block4.1.mlp.fc2','teacher_layer':'backbone.block4.2.mlp.fc2',
        'loss_name':'ChannelWiseLossFeature',
        'loss_config':{'weight':1,'tau':1},
