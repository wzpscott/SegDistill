...
model = dict(
    ...
    distillation = [
        ...
        'loss_config':{
            ...
            'resize_config':False,
            'mask_config':False,
            'transform_config':{'loss_type':'spatial','kernel_size':3,'stride':3},
            'ff_config':{'in_channels':150, 'out_channels':150, 'kernel_size':1}
            },
        },
    ],
...
work_dir = '/apdcephfs/private_inchzhang/shared_info/logits_sg3'
