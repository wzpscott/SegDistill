...
model = dict(
    ...
    distillation=[
        dict(
            ...
            teacher_layer=[
                'backbone.block1.2.attn.ATTN', 'backbone.block1.2.attn.V'
            ],
            loss_name='TeacherRE',
            loss_config=dict(
                weight=1,
                tau=1,
                transform_config=dict(loss_type='channel', group_size=32),
        ...
        dict(
            ...
            teacher_layer=[
                'backbone.block2.3.attn.ATTN', 'backbone.block2.3.attn.V'
            ],
            loss_name='TeacherRE',
            loss_config=dict(
                weight=1,
        ...
        dict(
            ...
            teacher_layer=[
                'backbone.block3.5.attn.ATTN', 'backbone.block3.5.attn.V'
            ],
            loss_name='TeacherRE',
            loss_config=dict(
                weight=1,
